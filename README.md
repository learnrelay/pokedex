...
**Step 3.** Import required React Bootstrap components within ```ListPage.js``` file or your custom component files.
...
Now you are ready to use the imported React Bootstrap components within your component hierarchy defined in the render method. Here is an example [ListPage.js](https://github.com/manavsehgal/react-eshop/blob/master/src/ListPage.js) redone using React Bootstrap.
